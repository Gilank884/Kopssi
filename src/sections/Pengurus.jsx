            ...
            <div className="container mx-auto px-4 max-w-5xl">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold mb-3 text-gray-900">
                        <span className="text-red-600 border-b-4 border-red-600 pb-1">PENGURUS</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 member-grid">
                    {teamMembers.map((member, idx) => (
                        <div key={idx} className="member-card group bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-center relative overflow-hidden">
                            ...
                            <div className="w-20 h-20 mx-auto mb-4 bg-red-50 rounded-full flex items-center justify-center text-red-500 group-hover:bg-red-600 group-hover:text-white transition-colors duration-300">
                            ...
                            <span className="inline-block px-3 py-1 bg-gray-100 text-gray-600 text-xs font-bold rounded-full tracking-wider group-hover:bg-red-50 group-hover:text-red-600 transition-colors">
                                {member.role}
                            </span>
                        </div>
                    ))}
