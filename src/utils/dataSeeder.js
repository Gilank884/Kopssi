...
export const seedSynchronizedData = async () => {
    try {
        ...
        const mockMembers = [
            { full_name: 'AHMAD FAUZI', no_npp: '10001', nik: '3275010101850001', no_anggota: 'AG-24001', company: companies[0], work_unit: 'HO', role: 'ADMIN', status: 'AKTIF', phone: '081234567891', rek_gaji: '12345678', bank_gaji: 'BCA', joined_at: '2024-01-01' },
            { full_name: 'SITI AMINAH', no_npp: '10002', nik: '3275010101850002', no_anggota: 'AG-24002', company: companies[0], work_unit: 'HO', role: 'MEMBER', status: 'AKTIF', phone: '081234567892', rek_gaji: '12345679', bank_gaji: 'MANDIRI', joined_at: '2024-01-01' },
            { full_name: 'BUDI SANTOSO', no_npp: '10003', nik: '3275010101850003', no_anggota: 'AG-24003', company: companies[1], work_unit: 'BRANCH A', role: 'MEMBER', status: 'AKTIF', phone: '081234567893', rek_gaji: '12345680', bank_gaji: 'BNI', joined_at: '2024-01-01' },
            { full_name: 'DIANA LESTARI', no_npp: '10004', nik: '3275010101850004', no_anggota: 'AG-24004', company: companies[1], work_unit: 'BRANCH A', role: 'MEMBER', status: 'AKTIF', phone: '081234567894', rek_gaji: '12345681', bank_gaji: 'BRI', joined_at: '2024-01-01' },
            { full_name: 'EKO PRASETYO', no_npp: '10005', nik: '3275010101850005', no_anggota: 'AG-24005', company: companies[1], work_unit: 'BRANCH B', role: 'MEMBER', status: 'AKTIF', phone: '081234567895', rek_gaji: '12345682', bank_gaji: 'BSI', joined_at: '2024-01-01' },
            { full_name: 'FITRIANI', no_npp: '10006', nik: '3275010101850006', no_anggota: 'AG-24006', company: companies[2], work_unit: 'BRANCH C', role: 'MEMBER', status: 'AKTIF', phone: '081234567896', rek_gaji: '12345683', bank_gaji: 'DANAMON', joined_at: '2024-01-01' },
            { full_name: 'GIVAN ALFARIDZI', no_npp: '10007', nik: '3275010101850007', no_anggota: 'AG-24007', company: companies[2], work_unit: 'BRANCH C', role: 'MEMBER', status: 'KELUAR', phone: '081234567897', rek_gaji: '12345684', bank_gaji: 'CIMB', joined_at: '2023-01-01', tanggal_keluar: '2024-03-31', exit_realisasi_status: 'PENDING' },
            { full_name: 'HANI RAHMAWATI', no_npp: '10008', nik: '3275010101850008', no_anggota: 'AG-24008', company: companies[2], work_unit: 'BRANCH D', role: 'MEMBER', status: 'AKTIF', phone: '081234567898', rek_gaji: '12345685', bank_gaji: 'PERMATA', joined_at: '2024-01-01' },
            { full_name: 'INDRA WIJAYA', no_npp: '10009', nik: '3275010101850009', no_anggota: 'AG-24009', company: companies[3], work_unit: 'BRANCH E', role: 'MEMBER', status: 'AKTIF', phone: '081234567899', rek_gaji: '12345686', bank_gaji: 'OCBC', joined_at: '2024-01-01' },
            { full_name: 'JULIA KARTIKA', no_npp: '10010', nik: '3275010101850010', no_anggota: 'AG-24010', company: companies[3], work_unit: 'BRANCH E', role: 'MEMBER', status: 'AKTIF', phone: '081234567800', rek_gaji: '12345687', bank_gaji: 'MEGA', joined_at: '2024-01-01' },
        ];
