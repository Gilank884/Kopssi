...
const AdminLayout = () => {
    ...
    return (
        <div className="flex h-screen bg-gray-50 font-sans text-gray-800">
            ...
            >
                <div className="h-16 flex items-center justify-center border-b border-gray-100 bg-red-600">
                ...
                <nav className="flex-1 py-6 px-3 space-y-1">
                    {navItems.map((item) => (
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                `flex items-center gap-3 px-3 py-3 rounded-lg transition-colors ${isActive ? 'bg-red-50 text-red-600 shadow-sm border border-red-100' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900'}`
                            }
                        >
                            <div>{item.icon}</div>
                ...
                <div className="p-3 border-t border-gray-100">
                    <button
                        ...
                        className="w-full flex items-center gap-3 px-3 py-3 rounded-lg text-gray-500 hover:bg-red-50 hover:text-red-600 transition-colors"
                    >
                        <LogOut size={20} />
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <header className="h-16 bg-white shadow-sm flex items-center justify-between px-6 z-10 border-b border-gray-200">
                    ...
                    <div className="flex items-center gap-6">
                        <button className="relative text-gray-500 hover:text-red-600">
                            <Bell size={20} />
                ...
                {/* Page Content */}
                <main className="flex-1 overflow-auto p-6 bg-red-50/30">
                    <Outlet />
                </main>
            </div>
